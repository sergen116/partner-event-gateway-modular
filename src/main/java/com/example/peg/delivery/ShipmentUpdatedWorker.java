...
public class ShipmentUpdatedWorker extends PgmqWorker {

    public ShipmentUpdatedWorker(JdbcTemplate j, ObjectMapper m, EventProcessor p,
    ...
    public String queueName() {
        return EventType.SHIPMENT_UPDATED.queueName();
    }
}
