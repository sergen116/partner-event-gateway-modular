...
public class OrderCancelledWorker extends PgmqWorker {

    public OrderCancelledWorker(JdbcTemplate j, ObjectMapper m, EventProcessor p,
    ...
    public String queueName() {
        return EventType.ORDER_CANCELLED.queueName();
    }
}
