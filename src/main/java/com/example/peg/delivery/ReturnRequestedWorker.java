...
public class ReturnRequestedWorker extends PgmqWorker {

    public ReturnRequestedWorker(JdbcTemplate j, ObjectMapper m, EventProcessor p,
    ...
    public String queueName() {
        return EventType.RETURN_REQUESTED.queueName();
    }
}
